   ...
   DoctorInforAdapter adapter;
    ...
    private void loadData() {
        ...
        while (cursor.moveToNext()) {
            ...
            InforDoctor doctor = new  InforDoctor(doctorID, doctorName, departmentName, doctorDescription, imageBytes);
            doctorInfor.add(doctor);
        }

            cursor.close();
            adapter = new DoctorInforAdapter(DoctorList.this, R.layout.doctor_mainlist, doctorInfor);
    ...
    private void addEvents() {
        ...
        binding.lvDoctor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                InforDoctor selectedDoctor = (InforDoctor) adapter.getItem(position);
